...
export type LifecycleState='PROVISIONING'|'PROVISIONING_FAILED'|'READY_FOR_ACTIVATION'|'LOCAL_BOOTSTRAP_REQUIRED'|'DEVICE_ACTIVATED'|'READY'|'BLOCKED'|'SETUP_REQUIRED'
